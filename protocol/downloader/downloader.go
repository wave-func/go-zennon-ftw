...
var (
	...
	blockSoftTTL    = 4 * time.Second  // Request completion threshold for increasing or decreasing a peer's bandwidth
	...
	maxBlockProcess = 512       // Number of blocks to import at once into the chain
)
